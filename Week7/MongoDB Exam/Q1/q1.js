// Please download the Enron email dataset enron.tar or enron.zip, untar or unzip
// it and then restore it using mongorestore. It should restore to a collection
// called "messages" in a database called "enron". Note that this is an
// abbreviated version of the full corpus. There should be 120,477 documents
// after restore.

// Inspect a few of the documents to get a basic understanding of the structure.
// Enron was an American corporation that engaged in a widespread accounting
// fraud and subsequently failed.
...
// For reference, the number of email messages from Andrew Fastow to John
// Lavorato (john.lavorato@enron.com) was 1.
