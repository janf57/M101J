...
public class UpdateRemoveTest {
	public static void main(final String[] args) throws UnknownHostException {
		final DBCollection collection = createCollection();

		final List<String> names = Arrays.asList("alice", "bobby", "cathy",
				"david", "ethan");
	...
	private static void scratch(final DBCollection collection) {
	...
	private static DBCollection createCollection() throws UnknownHostException {
		...
		final DBCollection collection = db.getCollection("UpdateRemoveTest");
		collection.drop();
		return collection;
	}

	private static void printCollection(final DBCollection collection) {
		final DBCursor cursor = collection.find().sort(
